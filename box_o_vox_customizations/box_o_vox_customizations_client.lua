...
radiant.events.listen_once(radiant,'radiant:client:server_ready', box_o_vox_customizations, box_o_vox_customizations._on_init)

return box_o_vox_customizations