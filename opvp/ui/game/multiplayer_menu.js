App.StonehearthMultiplayerMenuView = App.View.extend({
   ...
   actions: {
      ...
      setPlayerHostile: function() {
         ...
         var playerId = self.get('selectedRow.playerId');
         if (playerId) {
            radiant.call_obj('stonehearth.player', 'debug_set_amenity_command', playerId, 'hostile')
         }
      },
      setPlayerNeutral: function() {
         ...
         var playerId = self.get('selectedRow.playerId');
         if (playerId) {
            radiant.call_obj('stonehearth.player', 'debug_set_amenity_command', playerId,'neutral')
         }
      },
      setPlayerFriendly: function() {
         ...
         var playerId = self.get('selectedRow.playerId');
         if (playerId) {
            radiant.call_obj('stonehearth.player', 'debug_set_amenity_command', playerId, 'friendly')
         }
      },
